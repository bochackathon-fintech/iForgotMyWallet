...
namespace iForgotMyWallet.Core
{
	...
	public abstract class ServiceBase
	{
		...
		protected string BaseUri { get { return AppConfigs.BaseURI; } set { AppConfigs.BaseURI = value; } }
		...
		protected ThrottledHttp Web { get { return _http; } }
		...
		public ServiceBase (string uri, int maxConcurrent)
		{
			Init (uri, maxConcurrent);
		}
